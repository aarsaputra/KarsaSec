"""Kubernetes YAML Manifest AST Parser Plugin producing standardized FileNode and ASTNode objects."""
...
class KubernetesParserPlugin(ParserPlugin):
    """AST parser plugin for Kubernetes YAML manifests."""
    ...
    def parse_file(self, file_path: Path) -> ParseResult:
        ...
        return ParseResult(
            ...
            engine="Kubernetes Native Tokenizer",
        )


k8s_parser_plugin = KubernetesParserPlugin()
