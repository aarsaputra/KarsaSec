"""AST Visitor for Flask after_request response hooks."""
...
class FlaskAfterRequestVisitor:
    """Visits FunctionDef AST nodes to inspect after_request decorators."""
