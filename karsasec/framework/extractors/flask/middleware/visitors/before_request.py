"""AST Visitor for Flask before_request and before_first_request hooks."""
...
class FlaskBeforeRequestVisitor:
    """Visits FunctionDef AST nodes to inspect before_request decorators."""

    HOOK_NAMES = {"before_request", "before_first_request"}
    ...
    def visit(self, node: ASTNodeWrapper) -> None:
        ...
        for dec in raw.decorator_list:
            ...
            hook_func = parts[-1]
            if hook_func in self.HOOK_NAMES:
